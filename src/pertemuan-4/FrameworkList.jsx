        ...
        <div className="min-h-screen bg-[#fff5f6] p-8 font-sans">
            <div className="max-w-2xl mx-auto">
                ...
                {frameworkData.map((item) => (
                    <div 
                        key={item.id} 
                        className="group relative border-none p-6 mb-8 rounded-[2rem] shadow-xl shadow-rose-100/50 bg-white/80 backdrop-blur-sm hover:scale-[1.02] transition-all duration-300 ease-in-out"
                    >
                        {/* Aksen dekoratif pink di pojok */}
                        <div className="absolute top-0 right-0 w-20 h-20 bg-rose-50 rounded-tr-[2rem] rounded-bl-full -z-10 group-hover:bg-rose-100 transition-colors" />
