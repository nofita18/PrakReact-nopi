export default function TailwindCSS(){
    return (
        <>
            <FlexboxGrid/>
            <div>
                <h1 class="border m-4">Belajar tailwind</h1>
                <button className="bg-blue-950 text-lime-400
...
function Typography(){
    return (
        <div className="m-4">
            <h1 className="text-3xl font-extrabold text-blue-900">Tailwind Typography</h1>
...
function BorderRadius(){
    return (
        <>
        <button className="border-2 border-blue-900 text-orange-300 px-4 py-2 ml-4 rounded-l-2xl"> Klik Saya </button>
        <button className="border-2 border-blue-900 text-orange-300 px-4 py-2 ml-4 rounded-r-2xl"> Klik Saya </button>
        </>
    )
}
...
function BackgroundColors(){
    return(
        <div className="bg-blue-900 text-white m-4 p-6 rounded-lg shadow-lg">
...
function FlexboxGrid(){
    return (
        <nav className="flex justify-between bg-blue-900 p-4 text-white">
            <h1 className="text-orange-300 text-lg font-bold">MyWebsite</h1>
            <ul className="flex space-x-4">
                <li><a href="#">Home</a></li>
                <li><a href="#">About</a></li>
                <li><a href="#">Contact</a></li>
            </ul>
            <h1 className="text-red-400 text-lg font-bold">Logout</h1>
        </nav>
    )
}
...
function ShadowEffects(){
    return (
        <div className="bg-white shadow-lg m-4 p-6 rounded-lg hover:rotate-2 transition">
